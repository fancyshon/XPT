...
def get_args():
    ...
    parser.add_argument('--data_set', default='CIFAR100', 
        choices=['CIFAR100', 'CIFAR10', 'CUB2011', 'CUB2011U', 'Dogs', 'Caltech256', 'Car', "MiniImageNet"],
    ...
    # for proto_idx in range(1):
        ...
        if args.visual_type == 'slim_gaussian':
            ...
            for k in range(len(view_imgs)):
                ...
                cv2.imwrite(os.path.join(img_dir, "original_img_{}.jpg".format(token_reserve_num)), view_imgs[k])
